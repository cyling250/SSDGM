# This model comes from The Blog of DinoChen.com "http://www.dinochen.com/default.asp?cateID=42"
...
#puts "recorder"
recorder Node -file results/node37-$num.out -time -node 37 -dof 1 disp
recorder Node -file results/node28-$num.out -time -node 28 -dof 1 disp
recorder Node -file results/node28-force-$num.out -time -node 28 -dof 1 force
recorder Node -file results/node19-$num.out -time -node 19 -dof 1 disp
recorder Node -file results/node1-$num.out -time -node 1 -dof 1 disp
recorder Node -file results/node2-$num.out -time -node 2 -dof 1 disp
recorder Node -file results/node46-$num.out -time -node 46 -dof 1 disp
recorder Node -file results/node55-$num.out -time -node 55 -dof 1 disp
