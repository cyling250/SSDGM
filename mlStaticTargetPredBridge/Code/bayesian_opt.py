...
if __name__ == "__main__":
    rf_bayesian_opt("defobearing-" + str(1) + "-0.7")
    rf_bayesian_opt("defobearing-" + str(1) + "-4.0")
    rf_bayesian_opt("hpilebotty#" + str(1) + "-1-0.7")
    rf_bayesian_opt("hpilebotty#" + str(1) + "-1-4.0")
    # for i in range(1, 12, 2):
        # rf_bayesian_opt("defobearing-" + str(i) + "-0.7")
        # rf_bayesian_opt("defobearing-" + str(i) + "-4.0")
        # svm_bayesian_opt("defobearing-" + str(i) + "-0.7")
        # svm_bayesian_opt("defobearing-" + str(i) + "-4.0")
        # xgb_bayesian_opt("defobearing-" + str(i) + "-0.7")
        # xgb_bayesian_opt("defobearing-" + str(i) + "-4.0")
    # for i in range(1, 5):
        # rf_bayesian_opt("hpilebotty#" + str(i) + "-1-0.7")
        # svm_bayesian_opt("hpilebotty#" + str(i) + "-1-0.7")
        # xgb_bayesian_opt("hpilebotty#" + str(i) + "-1-0.7")
        # rf_bayesian_opt("hpilebotty#" + str(i) + "-1-4.0")
        # svm_bayesian_opt("hpilebotty#" + str(i) + "-1-4.0")
        # xgb_bayesian_opt("hpilebotty#" + str(i) + "-1-4.0")
